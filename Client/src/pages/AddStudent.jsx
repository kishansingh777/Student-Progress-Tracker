      ...
      if (csvData) {
        for (const row of csvData) {
          const payload = {
            ...
            studentClassId: selectedClass._id,
            marks: {
              [selectedClass.subject.subject1]: row.subject1,
              [selectedClass.subject.subject2]: row.subject2,
              [selectedClass.subject.subject3]: row.subject3,
              [selectedClass.subject.subject4]: row.subject4,
              [selectedClass.subject.subject5]: row.subject5,
            },
